...
<!--[if gt IE 9]><!--> <html lang='fr-FR' class='no-js'> <!--<![endif]-->
	...
	<head>
		...
		<?php if($page=='Projets'){ ?>
			<meta name='description' content="Découvrez mes diverses réalisations, sites web responsive et éditables, applications, créations graphiques.">
		<?php }else if($page=='A propos'){ $class = 'apropos'; ?>
			<meta name='description' content="Je suis passionée de web et de développement front-end spécfiquement. Découvrez mon parcours et mes compétences.">
		...
		<?php }else{ ?>
			<meta name='description' content="Elisabeth Hamel Portfolio // Développeuse Front-End et WordPress, découvrez mes projets et mes compétences - HTML5 / CSS3 / jQuery ... N'hésitez pas à me contacter !">
		<?php } ?>
