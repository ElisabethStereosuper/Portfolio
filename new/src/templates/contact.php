...
<html lang='en-EN' class='no-js'>
    ...
    <body>
        ...
        <footer role='contentinfo' class='container' id='footer'>
            <span>&copy;2016 Elisabeth Hamel -</span>
            <a href='#'>Legal informations</a>

            <ul class='social'>
                <li><a href='https://github.com/ElisabethStereosuper'><svg class='icon'><use xlink:href='#icon-github'/></svg>GitHub</a></li>
                <li><a href='https://codepen.io/elisabeth_hamel/'><svg class='icon'><use xlink:href='#icon-codepen'/></svg>Codepen</a></li>
                <li><a href='https://twitter.com/Elisabeth_Hamel'><svg class='icon'><use xlink:href='#icon-twitter'/></svg>Twitter</a></li>
                <li><a href='https://www.linkedin.com/in/elisabeth-hamel-7757b85a'><svg class='icon'><use xlink:href='#icon-linkedin'/></svg>LinkedIn</a></li>
            </ul>
        </footer>
